...
print(all_stocks.isna().sum(axis = 0))
...
for company in all_stocks.columns:
    print(f"    {company}: {round(all_stocks[company].mean(), 2)}")
    
# Print the median stock price for each stock
print("Median stock price:")
for company in all_stocks.columns:
    print(f"    {company}: {round(all_stocks[company].median(), 2)}")
    
# Print the standard deviation of the stock price for each stock  
print("Standard deviation of the stock price:")
for company in all_stocks.columns:
    print(f"    {company}: {round(all_stocks[company].median(), 2)}")
